...
/**
 * <p>
 * Parses the XML tag "config" when using the XML namespace "oscache". Creates
 ...
 * @author Alex Ruiz
 */
public final class OsCacheFacadeParser extends
  ...
  protected Class getCacheManagerClass() {
    return OsCacheManagerFactoryBean.class;
  }
