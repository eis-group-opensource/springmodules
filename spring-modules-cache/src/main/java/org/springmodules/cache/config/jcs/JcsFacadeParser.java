...
/**
 * <p>
 * Parses the XML tag "config" when using the XML namespace "jcs". Creates and
 ...
 * @author Alex Ruiz
 */
public final class JcsFacadeParser extends
  ...
  protected Class getCacheManagerClass() {
    return JcsManagerFactoryBean.class;
  }
