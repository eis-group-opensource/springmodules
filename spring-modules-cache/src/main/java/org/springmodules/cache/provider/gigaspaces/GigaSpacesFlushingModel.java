...
/**
 * <p>
 * Configuration options needed to flush one or more caches from GigaSpaces.
 * </p>
 *
...
public final class GigaSpacesFlushingModel extends AbstractFlushingModel {
   ...
   *
   * @param csvCacheNames
   *          a comma-separated list containing the names of the GigaSpaces caches
   ...
   *
   * @param newCacheNames
   *          the names of the GigaSpaces caches to flush
   */
  ...
  /**
   * @return the names of the GigaSpaces caches to flush
   */
  ...
  /**
   * Sets the names of the GigaSpaces caches to flush. It also removes any
